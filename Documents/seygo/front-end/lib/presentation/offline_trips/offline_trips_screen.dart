...
/// Shows all locally cached offline content — route trips and saved destinations.
  ...
  Future<void> _confirmClearAll(List<OfflineCacheItem> items) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'This will permanently delete all saved offline trips and destinations.'),
        actions: [
          TextButton(
