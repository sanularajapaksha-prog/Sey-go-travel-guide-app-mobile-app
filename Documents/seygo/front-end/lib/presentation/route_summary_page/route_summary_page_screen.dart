...
///
/// Each [ItineraryStopCard] accepts a [googleUrl] from the
/// `places.google_url` database column to load real Google Places photos.
///
/// Note: The production version of this screen is:
///   presentation/trip_summary/route_summary_itinerary_screen.dart
/// which is data-driven and receives stops from the route optimizer.
/// This version is useful as a design preview / static prototype.
class RouteSummaryPageScreen extends StatelessWidget {
  const RouteSummaryPageScreen({super.key});
          ...
          Expanded(
            child: ListView(
              ...
              children: const [
                ...
                // Replace googleUrl values with real google_url from your DB
                ItineraryStopCard(
                  index: 1,
...
/// A single itinerary stop card.
/// Provide [googleUrl] from `places.google_url` to display a real place photo.
class ItineraryStopCard extends StatelessWidget {
  ...
  /// Full google_url from DB e.g. "https://maps.google.com/?cid=55190463"
