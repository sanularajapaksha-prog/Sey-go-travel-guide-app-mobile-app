...
class _MapPageState extends State<MapPage> {
  ...
  void _onPlaceSelected(double lat, double lng, String name) {
    ...
    // ✅ Cinematic 3D fly-in with tilt and bearing
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // 3. Floating Add to Cart Button (Appears after selection)
          if (_showCartButton)
            Positioned(
          ...
          // 4. ✅ PERSISTENT DRAGGABLE PLAYLIST SHEET
            ...
            builder: (context, scrollController) {
              return Container(
                ...
                child: ListView.builder(
                  controller: scrollController, // ✅ Critical: Connects list gestures to sheet expansion
                  physics: const AlwaysScrollableScrollPhysics(), // ✅ Allows dragging even when empty
  ...
  Widget _buildPlaylistTile(int i) {
    ...
    return ListTile(
      ...
      trailing: IconButton(
        ...
        onPressed: () => setState(() {
          _markers.removeWhere((m) => m.position == item.position);
